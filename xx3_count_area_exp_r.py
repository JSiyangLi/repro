...
emap_path = os.path.join(base_dir, "27_b1.emap")
secondary_emap = os.path.join(base_dir, "27_b08.emap")
evtfile = os.path.join(base_dir, "hrcf00027_repro_evt2.fits")
region_file = os.path.join(base_dir, "b1_xray.xyreg")
theta_file = os.path.join(base_dir, "b1_xray.xyoffx")
